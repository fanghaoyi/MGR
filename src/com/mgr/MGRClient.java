...
*/
		...
		mgr_serverInfo.setMGR_serverOnline(0);
		mgr_serverInfo.setMGR_serverSock(0);
		mgr_serverInfo.setMGR_serverIpAddr("192.168.123.1");
		mgr_serverInfo.setMGR_serverDoorCode("1234");
